    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post(
                'https://sushiserver-bbabf5dvhsdperbb.southeastasia-01.azurewebsites.net/api/account/register',
                formData
            );
                    ...
                    <form className='register-form' onSubmit={handleSubmit}>
                        <div className="box-container-register">
                            ...
                            <InputBox
                                ...
                                onChange={handleChange}
                                error={error && !/\S+@\S+\.\S+/.test(formData.email) ? 'Invalid email address' : undefined}
                            />
                        ...
                        <div className="foot-panel w-full flex justify-center items-center flex-col">
                            <Button type='submit' content={isLoading ? 'Registering...' : 'Register'} disabled={isLoading} />
